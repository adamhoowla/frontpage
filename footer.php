...
-->
		...
		<footer role="contentinfo">
			<div class="grid">
				...
				<div class="col-25">
					<h2>Find Us:</h2>
					<ul>
						<li><a href="https://twitter.com/hoowla" class="icon-twitter"></a></li>
					</ul>
					<a href="https://twitter.com/hoowla" class="twitter-follow-button" data-show-count="false" data-size="large">Follow @hoowla</a>
				</div>

				<div class="col-25">
					<h2>Design:</h2>
					<a href="http://www.clockworkbear.com" class="clockworkbear-logo"><img src="images/clockworkbearLogo.png" alt="web design by Clockwork Bear" /></a>
					<p><a href="http://www.clockworkbear.com">clockworkbear.com</a></p>
				</div>
		...
		<!-- Hand-written Hoowla JS -->
		<script src="js/jhoowla.js"></script>
		...
		<script>
		  ...
		  ga('create', 'UA-41852408-1', 'hoowla.com');
		  ga('send', 'pageview');
		</script>
