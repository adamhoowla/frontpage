<?php include("header.php"); ?>
			...
			<section class="dark banner">
				<!-- TODO ALT -->
				<div class="grid">
					<img src="images/hoowlabanner.png" alt="" />
				</div>
			</section>
			...
			<section class="screenshot-grid">
				...
				<div class="grid">
					...
					<div class="col-55 even">
						<h2>Replace your existing case management software</h2>
				...
				<div class="grid">
					<div class="col-55 odd">
						...
						<p>Hoowla allows you to monitor statistics per solicitor in real time and allow clients and estate agents to leave feedback for you to read.</p>
					</div>
					<div class="col-45">
				...
				<div class="grid">
					...
					<div class="col-55 even">
						<h2>Partner overview of all staff &amp; conveyancing cases</h2>
						<p>Hoowla gives you an easy to understand snap shot view of your business. Data about your firm is displayed to allow you to understand what is and isn't working.</p>
				...
				<div class="grid">
					<div class="col-55 odd">
						<h2>See how each solicitor is performing for the firm in an instant</h2>
						<p>With multiple solicitors working in a number of branches it can be hard to keep on top of who is performing.</p>
						<p>Hoowla allows you to monitor statistics per solicitor in your firm and give clients and estate agents the ability to leave feedback for you to read.</p>
					</div>
					<div class="col-45">
						<img src="images/socOverview2.jpg" alt="" />
					</div>
				</div>

				<div class="grid">
					<div class="col-45">
						<img src="images/hoowlaEstateAgentView.jpg" alt="" />
					</div>
					<div class="col-55 even">
						<h2>Break down of offers and cases for Estate Agents</h2>
						<p>Estate agents can login to Hoowla too and manage their clients' offers. Directly linking it to the client's solicitor.</p>
				...
				<div class="grid">
					<div class="col-55 odd">
						...
						<p>Hoowla aims to reduce paper work where possible and bring the conveyancing process online.</p>
					</div>
					<div class="col-45">
						<img src="images/E-SignatureExample.jpg" alt="" />
					</div>
				</div>
			</section>
<!--
			<section class="green free-trial">
				<div class="grid">
					<div class="col-80">
						<h2>If you are an Estate Agent or Solicitor try a <span>FREE</span> trail today.</h2>					<ul>
					...
					<div class="col-20">					
						<a href="#" class="find-out-more-button">Find out <span>More</span></a>
					</div>
				</div>
			</section>
-->
